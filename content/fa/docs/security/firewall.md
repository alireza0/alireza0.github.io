...
اگر کانفیگ را به صورت رایگان پخش می‌کنید، می‌توانید فایروال را به نحوی تنظیم کنید که برای پورت فیلترشکن، تنها امکان اتصال از IP ایران وجود داشته باشد. چون لیست IP ایران کاملا شفاف و مشخص نیست، تعریف چنین محدودیتی در سرور راحت نیست. ولی اگر از CDN استفاده می‌کنید، سرویس CDN سرویس فایروال بر اساس کشور را ارائه می‌دهد. 
همچنین برای افزایش امنیت پنل و پیدا نشدن آن توسط فیلترچی، می‌توانید برای پورت پنل تنظیمات برعکسی را انجام دهید که پنل از داخل ایران باز نشود و خودتان برای اتصال به پنل، از VPN استفاده کنید.
